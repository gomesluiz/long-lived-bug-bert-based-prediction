...
BERT adds the \textsc{[CLS]} token at the beginning of the first sentence and used for classification tasks. This token holds the aggregate representation of the input sentence. The \textsc{[SEP]} token indicates the end of each sentence~\cite{Ravichandiran:2021}. Figure~\ref{fig:bert-three-embedding} shows the embedding generation process executed by the WordPiece tokenizer. First, the tokenizer converts input sentences into tokens before figuring out token embeddings. Thereafter, these tokens feed segment and position embeddings computations. Lastly, the tokenizer sum all embeddings and inputs the results into BERT. Figure~\ref{fig:bert-three-embedding} described three kinds of embeddings~\cite{Devlin:2019}.
...
BERT has many variant models to be more efficient or be more adapted to several contexts.

\begin{table}[!ht]
\begin{tabular}{@{}lllll@{}}
\toprule
Model     &  L & H & A \\ \midrule
\textbf{ALBERT\textsubscript{BASE}}         &   &   &   \\
\textbf{BERT\textsubscript{SMALL-M1}}       &   &   &   \\
\textbf{BERT\textsubscript{SMALL-M2}}       &   &   &   \\
\textbf{BERT\textsubscript{SMALL-M3}}       &   &   &   \\
\textbf{BERT\textsubscript{SMALL-M4}}       &   &   &   \\
\textbf{BERT\textsubscript{BASE}}           &   &   &   \\
\textbf{DISTILBERT}                         &   &   &   \\
\textbf{ELECTRA\textsubscript{BASE}}        &   &   &   \\ 
\textbf{ELECTRA\textsubscript{SMALL}}       &   &   &   \\ 
\textbf{ROBERTA\textsubscript{BASE}}        &   &   &   \\ 
\bottomrule
\end{tabular}
\end{table}
